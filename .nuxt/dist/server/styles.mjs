...
export default {
  "pages/comment.vue": () => import('./_nuxt/comment-styles.0902886d.mjs').then(interopDefault),
  ...
  "pages/index.vue": () => import('./_nuxt/index-styles.55c3b823.mjs').then(interopDefault)
}