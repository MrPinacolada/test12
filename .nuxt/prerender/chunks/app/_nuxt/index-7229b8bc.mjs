...
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderList, ssrRenderClass, ssrInterpolate } from 'file://C:/Users/Bob/Desktop/testing/test12/node_modules/vue/server-renderer/index.mjs';
...
function _sfc_ssrRender$2(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  if ($props.currentPage > 1) {
    _push(`<button class="pagination-button"> \u041D\u0430\u0437\u0430\u0434 </button>`);
  } else {
    _push(`<!---->`);
  }
  _push(`</div>`);
  ...
  ssrRenderList($setup.comments, (comment) => {
    _push(ssrRenderComponent(_component_NuxtLink, {
      ...
      default: withCtx((_, _push2, _parent2, _scopeId) => {
        if (_push2) {
          _push2(`<tr${_scopeId}><td${_scopeId}><div class="${ssrRenderClass([{
            ...
            red: comment.id > 150
          }, "circle"])}"${_scopeId}>${ssrInterpolate(comment.id)}</div></td><td${_scopeId}>${ssrInterpolate(comment.name)}</td><td${_scopeId}><div class="${ssrRenderClass([{
            green: comment.id <= 50,
            blue: comment.id > 50 && comment.id <= 100,
            red: comment.id > 100 && comment.id <= 150,
            orange: comment.id > 150
          }, "cloud"])}"${_scopeId}>${ssrInterpolate(comment.email)}</div></td></tr>`);
        } else {
          return [
            createVNode("tr", null, [
              createVNode("td", null, [
              ...
              createVNode("td", null, [
                ...
                }, toDisplayString(comment.email), 3)
              ])
            ])
          ];
        }
...
//# sourceMappingURL=index-7229b8bc.mjs.map
