...
const styles = {
  "pages/comment.vue": () => import('./_nuxt/comment-styles.355513f9.mjs').then(interopDefault),
  ...
  "pages/index.vue": () => import('./_nuxt/index-styles.91bcc1d0.mjs').then(interopDefault)
};
